...
import type { ProviderInfo, ProviderModelInfo } from '@devaid/ai-contracts'
...
test('AI 路由分离授权、候选目录和已保存模型配置', async () => {
  ...
  const configuredDeepseek = (await configResponse.json()) as ProviderInfo
