...
interface OAuthSession {
  ...
  providerId: string
  sessionId: string
  status: OAuthSessionStatusResponse['status']
...
function publicPrompt(prompt: AuthPrompt): PublicOAuthPrompt {
  return {
...
export class OAuthSessionService {
  ...
  get(sessionId: string): OAuthSessionStatusResponse | undefined {
  ...
  private toStatus(session: OAuthSession): OAuthSessionStatusResponse {
    return {
