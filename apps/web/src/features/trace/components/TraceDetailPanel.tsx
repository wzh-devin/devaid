...
import { TraceKindChip } from './TraceKindChip'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tabs.Panel
          className="mt-0! min-h-0 flex-1 overflow-auto px-3 py-2"
          id="summary"
        >
          <dl className="grid grid-cols-[72px_minmax(0,1fr)] items-center gap-x-3 gap-y-1.5 text-xs">
            ...
            <dd>
              <Chip
                color={AGENT_TRACE_STATUS_COLORS[record.status]}
                size="sm"
                variant="soft"
              >
            ...
            <dd className="tabular-nums">
              {formatTraceDuration(record.startMs)}
            </dd>
          </dl>
          <div className="mt-3">
